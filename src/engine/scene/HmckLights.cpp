...
void Hmck::OmniLight::prepareCubeMap(Device &device) {
    ...
    imageCreateInfo.extent = {
        static_cast<uint32_t>(shadowCubeMap.width), static_cast<uint32_t>(shadowCubeMap.height), 1
    };
    imageCreateInfo.mipLevels = 1;
...
void Hmck::OmniLight::beginCubeMapFaceUpdate(const uint32_t faceIndex, const VkCommandBuffer commandBuffer) const {
...
void Hmck::OmniLight::endCubeMapFaceUpdate(const VkCommandBuffer commandBuffer) {
