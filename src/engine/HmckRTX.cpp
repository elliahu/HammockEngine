...
uint64_t Hmck::IRayTracingSupport::getBufferDeviceAddress(Device& device, VkBuffer buffer)
{
...
void Hmck::IRayTracingSupport::createAccelerationStructure(Device& device, AccelerationStructure& accelerationStructure, VkAccelerationStructureTypeKHR type, VkAccelerationStructureBuildSizesInfoKHR buildSizeInfo)
{
	// Buffer and memory
	...
	vkCreateAccelerationStructureKHR(device.device(), &accelerationStructureCreate_info, nullptr, &accelerationStructure.handle);
	// AS device address
	VkAccelerationStructureDeviceAddressInfoKHR accelerationDeviceAddressInfo{};
	accelerationDeviceAddressInfo.sType = VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR;
	accelerationDeviceAddressInfo.accelerationStructure = accelerationStructure.handle;
	accelerationStructure.deviceAddress = vkGetAccelerationStructureDeviceAddressKHR(device.device(), &accelerationDeviceAddressInfo);
}

Hmck::ScratchBuffer Hmck::IRayTracingSupport::createScratchBuffer(Device& device, VkDeviceSize size)
{
...
void Hmck::IRayTracingSupport::deleteScratchBuffer(Device& device, ScratchBuffer& scratchBuffer)
{
...
void Hmck::IRayTracingSupport::deleteAccelerationStructure(Device& device, AccelerationStructure& accelerationStructure)
{
...
void Hmck::IRayTracingSupport::loadFunctionPointers(Device& device)
{
