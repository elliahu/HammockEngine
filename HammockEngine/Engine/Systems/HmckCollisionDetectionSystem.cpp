...
bool Hmck::HmckCollisionDetectionSystem::intersect(HmckGameObject& obj1, HmckGameObject& obj2)
{
	...
	assert(obj2.boundingBox != nullptr && "Provided object 1 needs bounding box to calculate intersections !");

	return (
		obj1.boundingBox->x.min <= obj2.boundingBox->x.max &&
		obj1.boundingBox->x.max >= obj2.boundingBox->x.min &&
		obj1.boundingBox->y.min <= obj2.boundingBox->y.max &&
		obj1.boundingBox->y.max >= obj2.boundingBox->y.min &&
		obj1.boundingBox->z.min <= obj2.boundingBox->z.max &&
		obj1.boundingBox->z.max >= obj2.boundingBox->z.min
	);
}
